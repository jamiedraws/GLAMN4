...
<%--        <div class="vse"><%= Html.ValidationSummary("The following errors have occurred:") %></div>
        ...
        <div class="offer offer--banner">
            <div class="row-to-center u-vw--100 u-mar--vert @xl-u-mar--top @x3-mar">
                <div class="col @sm-u-vw u-mar--bottom @x2-mar">
                    <h4 class="offer__title sans-primary-bold"><%= productName %><br>5-Piece Deluxe Collection Kit.</h4>
                </div>
            ...
            <div class="row-to-center u-vw--100 u-mar--bottom @x3-mar">
                <div class="col @sm-u-vw offer__shot">
                    <div class="banner__gfx col @sm-u-vw u-pad--left @sm-u-pad--reset @x2-pad">
                        <div class="row-to-center center-margin">
                            <div class="col">
                                <img src="/images/graphics/2.0000/save-burst.png?appV=<%= DtmContext.ApplicationVersion %>" alt="Save $30">
                            </div>
                            <div class="col">
                    ...
                    <div class="highlight-container center-text u-vw--100"><span class="h4 sans-primary-bold uppercase">Best value</span></div>
                </div>
                <div class="col @sm-u-vw offer__desc sans-primary-book u-pad--left @x2-pad @sm-u-pad--reset u-mar--top @x2-mar">
                    <h5 class="color-secondary sans-primary-bold uppercase offer__title">Only Available In Salons &amp; Now Available To You!</h5>
                    <hr class="u-mar--vert">
                    <span class="h7 block"><em class="sans-primary-bold">Price: </em><em class="color-price">Retail Value of <span class="linethrough-text">$129.50</span> <span class="sans-primary-bold color-secondary">$99.00</span></em></span>

                    <span class="h7 block blockquote u-mar--vert @x2-mar"><em class="sans-primary-bold">Kit Includes:</em> <span class="sans-primary-book">Volumizing Shampoo, Hydrating Condition, Super Comb Prep &amp; Protect, Blow Dry Lotion and Reconstruction Masque.</span></span>

                    <div class="@sm-o-grid--none u-pad--vert @x2-pad"></div>

                    <a href="javascript:updateTcTxt()" data-code-toggle="true" data-code="N4KIT" class="order-button">Add To Cart</a>
                </div>
            </div>
        </div>
        ...
        <div id="promo" class="success-message-container u-vw--100">
            <div class="row-to-center u-vw--100">
                <div class="col @xs-u-vw--33 promo__label">
                    <label for="promoCode"><strong>PROMO CODE:</strong></label>
                </div>
                <div class="col row @xs-u-vw--66">
                    <div class="col @xs-u-vw--50 @dv-u-pad--horz @xs-u-pad--reset">
                        <input type="text" class="ddlPromo u-vw--100" name="promoCode" id="promoCode" style="text-transform: uppercase;"/>
                    </div>
                    <div class="col @xs-u-vw--50 u-mar--top">
            ...
            <div class="promo-message hide center-text top-margin">
                <div class="container bg--white u-vw--100 no-margin">
                    <i class="icon-checkmark"></i> <p class="promo-message__in column-block no-margin">Thank you! Your promo code was applied.</p>
                </div>
            </div>
        </div>
